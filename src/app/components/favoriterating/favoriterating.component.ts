import { Component, ElementRef, Renderer2, Output, EventEmitter, ViewChild, OnInit, AfterViewInit, OnChanges} from '@angular/core';
...
export class FavoriteratingComponent{
